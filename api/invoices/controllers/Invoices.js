...
module.exports = {
  ...
  /**
   * Add an entry to a specific Invoices.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Invoices.
   *
   * @return {Object}
   */
